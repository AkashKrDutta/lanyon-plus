...
{% endcomment %}
# **Welcome**
<i class="fa fa-quote-left fa-2x fa-pull-left fa-border" aria-hidden="true"></i><span style="font-family:Arizonia;font-size:100%">"By experiencing both, victory and defeat, running away and shedding tears, a man will become a man."&nbsp;&mdash;&nbsp;Shanks, One Piece</span>
